 ...
 */
@Embeddable
public class HotelesPK implements Serializable {
    ...
    public HotelesPK(int idHoteles, Date plazaDisponibleFechaDeRefencia) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HotelesPK)) {
            return false;
        }
        HotelesPK other = (HotelesPK) object;
    ...
    public String toString() {
        return "co.edu.udec.poo.entidades.HotelesPK[ idHoteles=" + idHoteles + ", plazaDisponibleFechaDeRefencia=" + plazaDisponibleFechaDeRefencia + " ]";
    }
